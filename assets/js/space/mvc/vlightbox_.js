$.extend(
	$.fn, {
		vLightbox: function(o) {
			...
			var vLightBoxVideoPlayer = function() {
			...
			this.show = function(opts) {
				...
				$(container).on('shown.bs.modal', function(e) {
					...
					/*if (objVideoJs != null) {
						...
						objVideoJs = videojs($(player).attr('id'),{"controls": true, "autoplay": false, "preload": "auto"});
					}

					objVideoJs.ready(function() {
						this.play();
					});*/
