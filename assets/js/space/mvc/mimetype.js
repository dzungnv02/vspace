...
MimeType.set(".doc,.docx,.dot", "application/msword");
...
MimeType.set(".xls,.xlsx,.xlm,.xla,.xlc,.xlt,.xlw", "application/vnd.ms-excel");
...
MimeType.set(".ppt,.pptx,.pps,.pot", "application/vnd.ms-powerpoint");
...
MimeType.set(".txt,.text,.conf,.def,.list,.log,.in,.md,.htacess,.rst,.gitignore", "text/plain");
...
MimeType.set(".dat,.iso", "application/octet-stream");
MimeType.set(".php", "application/x-httpd-php-source");
...
MimeType.set(".tar", "application/x-tar");
MimeType.set(".dmg", "application/x-apple-diskimage");
