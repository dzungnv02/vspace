...
(function () {
    (function (a, b, c) {
        ...
        d.prototype._touchend = function (b) {
            ...
            f.position() .left > 0.5 * this.options.width || f.position() .left > 0.1 * this.options.width && 250 > Number(new Date) - this.data.touchtimer ? (a.data(this, 'direction', 'previous'), this._slide())  : f.position() .left < - (0.5 * this.options.width) || f.position() .left < - (0.1 * this.options.width) && 250 > Number(new Date) - this.data.touchtimer ? (a.data(this, 'direction', 'next'), this._slide())  : (e = this.data.vendorPrefix, i = e + 'Transform', d = e + 'TransitionDuration', g = e + 'TransitionTimingFunction', f[0].style[i] = 'translateX(0px)', f[0].style[d] = 0.85 * this.options.effect.slide.speed + 'ms'),
        ...
        d.prototype._getVendorPrefix = function () {
            ...
            e,
            f;
            for (a = c.body || c.documentElement, d = a.style, e = 'transition', f = [
                'Moz',
                'Webkit',
                'Khtml',
                'O',
                'ms'
            ], e = e.charAt(0) .toUpperCase() + e.substr(1), b = 0; f.length > b; ) {
