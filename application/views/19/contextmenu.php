...
<ul id="gridMenuDir" class="contextMenu">
	<li class="open"><a href="#open">Mở</a></li>
	<li class="preview"><a href="#preview">Xem trước</a></li>
	<li class="newfolder separator"><a href="#newfolder">Tạo thư mục mới</a></li>
	<li class="share separator"><a href="#share">Chia sẻ</a></li>
	<li class="copy separator"><a href="#copy">Sao chép đến ...</a></li>
	<li class="cut"><a href="#cut">Di chuyển đến...</a></li>
	<li class="delete"><a href="#delete">Xóa</a></li>
...
<ul id="gridMenuFile" class="contextMenu">
	<li class="open"><a href="#open">Mở</a></li>
	<li class="preview"><a href="#preview">Xem trước</a></li>
	<li class="newfolder separator"><a href="#newfolder">Tạo thư mục mới</a></li>
	<li class="share separator"><a href="#share">Chia sẻ</a></li>
...
<ul id="gridMenuParent" class="contextMenu">
	<li class="open"><a href="#open">Mở</a></li>
	<li class="preview"><a href="#preview">Xem trước</a></li>
	<li class="newfolder separator"><a href="#newfolder">Tạo thư mục mới</a></li>
	<li class="share separator"><a href="#share">Chia sẻ</a></li>
